...
class PetFriends:
    ...
    def add_new_pet_without_photo(self, auth_key: json, name: str, animal_type: str,
                                  age: str) -> json:
        """Метод отправляет (постит) на сервер данные о добавляемом питомце без фотографии
    ...
    def add_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод добавляет фотографию питомца созданного методом add_new_pet_without_photo"""
    ...
    def add_new_pet_with_incorrect_auth_key(self, auth_key: str, name: str,
